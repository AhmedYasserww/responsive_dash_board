  ...
  PieChartData getChartData() {
    return PieChartData(
      ...
      sections: [
        PieChartSectionData(
          ...
          value: 40,
          titleStyle: Styles.styleRegular16.copyWith(color:activeIndex==0?null: Colors.white),
        ...
        PieChartSectionData(
            ...
            value: 25,
            titleStyle: Styles.styleRegular16.copyWith(color:activeIndex==1?null: Colors.white),
    ...
    title: activeIndex==1?'Design Product':"25%", color: const Color(0xff4EB7F2)),
        ...
        PieChartSectionData(
            ...
            value: 20,
            titleStyle: Styles.styleRegular16.copyWith(color:activeIndex==2?null: Colors.white),
            radius: activeIndex == 2?60 : 50,
    title: activeIndex==2?'Product royalti':"20%", color: const Color(0xff064061)),
        PieChartSectionData(
            titlePositionPercentageOffset: activeIndex==3?1.5:null,
            value: 22,
            titleStyle: Styles.styleRegular16.copyWith(color:activeIndex==3?null: Colors.white),
